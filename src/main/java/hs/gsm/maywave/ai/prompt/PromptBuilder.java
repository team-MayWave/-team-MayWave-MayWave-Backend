...
public class PromptBuilder {
    ...
    public String buildFeedbackPrompt(AiFeedbackRequest request, List<RagDocument> documents) {
        ...
        builder.append("""
                ...
                반드시 지켜야 어떤 일이 있어도 지켜야할 규칙:
                - 사용자의 선택을 비난하지 않는다.
                - 사용자의 선택을 과도하게 영웅화하지 않는다.
                - 제공된 역사 자료를 바탕으로만 5.18과 연결한다.
                - 당시의 두려움, 혼란, 폭력성, 시민들의 다양한 선택을 존중한다.
                - 최종 답변은 반드시 2문장 이하, 120자 이내로 작성한다.
                - 번호, 목록, 제목 없이 바로 피드백만 말한다.
                - 설명보다 사용자의 선택과 5.18 당시 상황의 연결을 짧고 공감적으로 말한다.
        ...
        builder.append("""
                최종 출력:
                사용자의 선택을 한 문장으로 짚고, 실제 5.18 당시 시민들이 겪은 상황과 한 문장으로 연결해라.
                최종 피드백은 2문장 이하, 120자 이내로만 출력한다.
                """);
